...
data <- read.csv("/Users/Yuval/Downloads/CircadianRNAseq.csv", header = TRUE)
...
z <- sorted_indices[1:10]
top_10_circadian_genes
z_scores[temp]
temp #should be compared to sorted_indices.